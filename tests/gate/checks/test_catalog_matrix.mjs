...
assert.equal(all.length, 483, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 68, "the exhaustive tier must cover every dataset");
