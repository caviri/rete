...
assert.equal(all.length, 435, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 60, "the exhaustive tier must cover every dataset");
