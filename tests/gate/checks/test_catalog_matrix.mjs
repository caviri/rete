...
assert.equal(all.length, 461, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 64, "the exhaustive tier must cover every dataset");
