...
assert.equal(all.length, 637, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 91, "the exhaustive tier must cover every dataset");
