...
assert.equal(all.length, 477, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 67, "the exhaustive tier must cover every dataset");
