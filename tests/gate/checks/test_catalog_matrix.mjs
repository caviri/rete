...
assert.equal(all.length, 501, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 69, "the exhaustive tier must cover every dataset");
