...
assert.equal(all.length, 644, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 93, "the exhaustive tier must cover every dataset");
