...
assert.equal(all.length, 450, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 62, "the exhaustive tier must cover every dataset");
