...
assert.equal(all.length, 565, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 80, "the exhaustive tier must cover every dataset");
