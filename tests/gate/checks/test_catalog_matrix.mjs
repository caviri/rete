...
assert.equal(all.length, 553, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 78, "the exhaustive tier must cover every dataset");
