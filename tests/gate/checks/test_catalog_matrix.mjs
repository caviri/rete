...
assert.equal(all.length, 445, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 61, "the exhaustive tier must cover every dataset");
