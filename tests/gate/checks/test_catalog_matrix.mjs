...
assert.equal(all.length, 467, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 65, "the exhaustive tier must cover every dataset");
