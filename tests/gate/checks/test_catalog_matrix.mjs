...
assert.equal(all.length, 517, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 73, "the exhaustive tier must cover every dataset");
