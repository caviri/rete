...
assert.equal(all.length, 431, "every catalog query must be in the exhaustive matrix");
...
assert.equal(allGroups.length, 59, "the exhaustive tier must cover every dataset");
