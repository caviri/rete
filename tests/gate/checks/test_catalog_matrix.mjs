...
try {
  ...
  // 637 -> 644 -> 651 -> 656 -> 664 -> 669 -> 676: this literal has to be raised by hand every time
  ...
  // run of this gate.
  t.equal("allQueries", all.length, 676, "every catalog query must be in the exhaustive matrix");
  ...
  t.equal("allDatasets", allGroups.length, 99, "the exhaustive tier must cover every dataset");
