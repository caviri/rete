...
window.RETE_PLAYGROUND_CATALOG = {
  ...
  datasetMeta: {
    ...
    "ramon_llull":           { triples: 2593,      size: "85 KB",   license: "CC BY 4.0",            source: "https://bvpb.mcu.es/",                                      provenance: "The complete Ramón Llull microsite of the Biblioteca Virtual del Patrimonio Bibliográfico (Ministerio de Cultura, España): 142 records enumerated via the author-authority navigation (BVPB20110039301) and harvested per-record (raw catalogue HTML + RDF Dublin Core export + the digitised-object PDF) by scripts/bvpb_ramonllull.py, modelled to EDM/Dublin Core N-Triples by scripts/bvpb_to_nt.py, built with rete build --pyramid-algo types --card. Each edm:ProvidedCHO links edm:isShownBy -> its full PDF on bvpb.mcu.es (the 142 PDFs, ~13 GB, are kept locally, not in the graph). Remote-lazy. CC BY 4.0 - credit the BVPB." },
  ...
  datasetExtra: {
    ...
    "ramon_llull":           { icon: "🗝️", tags: ["Ramón-Llull", "manuscripts", "rare-books", "medieval", "Mallorca", "Latin-Catalan", "BVPB", "PDF"] },
