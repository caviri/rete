...
window.RETE_PLAYGROUND_CATALOG = {
  ...
  perf: {
    ...
    "mira": { "Manuscripts you can SEE (IIIF)": 2, "Where early Irish books were made": 2, "The scholars, linked to Wikidata": 1, "Datable manuscripts over time": 2, "The largest manuscripts": 1, "Search the contents": 1, "What the catalogue describes": 1 },
  ...
  datasetMeta: {
    ...
    "mira":                  { triples: 4538,      size: "124 KB",  license: "CC BY-NC-SA 4.0",      source: "https://www.mira.ie",                                      provenance: "MIrA (Manuscripts with Irish Associations, Pádraic Moran / University of Galway): the Wikidata-aligned RDF dump from github.com/padraicmoran/MIrA, enriched by scripts/mira_to_nt.py with IIIF manifests (wdt:P6108) + name/script/folios/contents from the per-manuscript XML, and rdfs:labels for every wd:Q*/wdt:P* code fetched from the Wikidata API. rete build --pyramid-algo types --type-predicate P31 --text-index --card." },
