...
window.RETE_PLAYGROUND_CATALOG = {
  ...
  perf: {
    ...
    "mira": { "Manuscripts you can SEE (IIIF)": 2, "Where early Irish books were made": 2, "The scholars, linked to Wikidata": 1, "Cross-source JOIN: MIrA people × live Wikidata": 1, "Datable manuscripts over time": 2, "The largest manuscripts": 1, "Search the contents": 1, "What the catalogue describes": 1, "Why each book is in the corpus": 1, "The Old Irish glossed books (with images)": 1 },
