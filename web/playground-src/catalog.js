...
window.RETE_PLAYGROUND_CATALOG = {
  ...
  pmtiles: {
    ...
    "geoadmin-tiles": {
      url: "https://katospiegel-rete.hf.space/data/playground/geoadmin-tiles.rete?token=sfdbgf1094by21hd128ru39802",
      embedded: true,
  ...
  datasets: [
    ...
    {"key": "wikidata-xxl", "kind": "remote-lazy", "typePredicate": "<http://www.wikidata.org/prop/direct/P31>", "url": "https://katospiegel-rete.hf.space/data/playground/wikidata-xxl/shard_0000.rete?token=sfdbgf1094by21hd128ru39802", "shards": ["https://katospiegel-rete.hf.space/data/playground/wikidata-xxl/shard_0000.rete?token=sfdbgf1094by21hd128ru39802", "https://katospiegel-rete.hf.space/data/playground/wikidata-xxl/shard_0001.rete?token=sfdbgf1094by21hd128ru39802", "https://katospiegel-rete.hf.space/data/playground/wikidata-xxl/shard_0002.rete?token=sfdbgf1094by21hd128ru39802", "https://katospiegel-rete.hf.space/data/playground/wikidata-xxl/shard_0003.rete?token=sfdbgf1094by21hd128ru39802", "https://katospiegel-rete.hf.space/data/playground/wikidata-xxl/shard_0004.rete?token=sfdbgf1094by21hd128ru39802", "https://katospiegel-rete.hf.space/data/playground/wikidata-xxl/shard_0005.rete?token=sfdbgf1094by21hd128ru39802"], "label": "wikidata-xxl - 600M-triple Wikidata as 6 federated .rete shards (ONE logical graph, sharded)", "description": "The SHARDED-RETE model at scale: one logical Wikidata graph too big to build as a single file, split into 6 INDEPENDENT --no-pyramid .rete shards (100M triples / ~906 MB each, ~5.4 GB total) that the playground AUTO-FEDERATES — every query fans across all 6 shards (UNION) and the rows merge, so you query it like one dataset. A genuine cross-section of the Wikidata truthy dump (people, places, works, taxa, properties) streamed partition-by-partition from the piebro/wikidata-extraction Parquet (DuckDB httpfs, no full download) and built shard-by-shard with bounded RAM/disk (stream → rete build --no-pyramid → drop the 10 GB N-Triples → next). Each entity carries multilingual rdfs:label / skos:prefLabel / schema:name + schema:description, rdf:type / wdt:P31, and truthy wdt:* statements (occupation P106, etc.); IRIs stay wikidata.org/{entity,prop/direct}/* so nodes round-trip to live Wikidata. This proves the .rete format + client-side federation scale to a dataset BIGGER THAN ANY SINGLE FILE — the path to full Wikidata (~80 shards, ~80 GB) is just more shards. Datatypes are heuristic (typed dateTime + WKT; numbers plain) since WDQS rate-limits the property-datatype map. The fed bar shows '⛓ 6 shards'. Built by scripts/build_wikidata_xxl.sh. CC0 (Wikidata)."},
