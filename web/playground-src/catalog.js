...
window.RETE_PLAYGROUND_CATALOG = {
  ...
  datasetMeta: {
    ...
    "lineara":               { triples: 38126,     size: "352 KB",  license: "No explicit license (scholarly; attribute GORILA/Douros/mwenge)", source: "https://lineara.xyz",                                          provenance: "The LinearA Explorer corpus (github.com/mwenge/lineara.xyz, LinearAInscriptions.js — text after GORILA/Godart-Olivier + George Douros's tabulation) converted to RDF by scripts/lineara_to_nt.js: Inscription → site/scribe/support/period + Linear A transcription + Latin transliteration, plus the sign/word layer (Inscription → Word → Sign and Inscription → Sign). Inscription images © EFA are excluded. rete build --pyramid-algo types --text-index --card." },
