...
[] a sh:NodeShape ;
  ...
  sh:property [ sh:path chebi:inchikey ; sh:minCount 1 ] .`
      },
      {
        ...
        tip: "Run after Cache remote. A second class: every substance (obo:CHEBI_59999) should carry an rdfs:label.",
        shape: `@prefix sh: <http://www.w3.org/ns/shacl#> .
@prefix obo: <http://purl.obolibrary.org/obo/> .
@prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> .
...
[] a sh:NodeShape ;
  ...
  sh:property [ sh:path rdfs:label ; sh:minCount 1 ;
    sh:message "Every classified member should carry a human-readable label." ] .`
      ...
      {
        label: "Entities in a P91 relation are named",
        tip: "A second target: every subject of P91 (the affiliation relation) should carry a label, so the network reads in plain language.",
        shape: `@prefix sh: <http://www.w3.org/ns/shacl#> .
@prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> .
@prefix fgp: <https://database.factgrid.de/prop/direct/> .
  ...
  sh:property [ sh:path mt:P5 ; sh:minCount 1 ;
    sh:message "A novel in the stylometric-similarity network should name its author (P5)." ] .`
      },
      {
        ...
        tip: "Every work that names an author (P5) should also carry a publication date (P9) — a few are undated.",
        shape: `@prefix sh: <http://www.w3.org/ns/shacl#> .
@prefix mt: <http://data.mimotext.uni-trier.de/prop/direct/> .
  ...
  sh:property [ sh:path wdt:P569 ; sh:minCount 1 ;
    sh:message "A person with an occupation (P106) should record a date of birth (P569)." ] .`
      },
      {
        ...
        tip: "Run after Cache remote. Every person with an occupation (wdt:P106) should record a country of citizenship (wdt:P27). Real Wikidata is incomplete, so expect violations.",
        shape: `@prefix sh: <http://www.w3.org/ns/shacl#> .
@prefix wdt: <http://www.wikidata.org/prop/direct/> .
...
[] a sh:NodeShape ;
  ...
  reach: {
    ...
    "factgrid-illuminati": {
      ...
      examples: [
        { label: "People linked to the Order of the Illuminati (P91)", pred: "<https://database.factgrid.de/prop/direct/P91>", seeds: "<https://database.factgrid.de/entity/Q10677>", reverse: true },
        { label: "P91 affiliations of a member", pred: "<https://database.factgrid.de/prop/direct/P91>", seeds: "<https://database.factgrid.de/entity/Q409>", reverse: false }
      ]
    },
    "linked-jazz": {
    ...
    mimotext: {
      ...
      examples: [
        { label: "Stylometric neighbourhood of a novel (P49)", pred: "<http://data.mimotext.uni-trier.de/prop/direct/P49>", seeds: "<http://data.mimotext.uni-trier.de/entity/Q1011>", reverse: false },
        { label: "Novels stylistically close to Q1022", pred: "<http://data.mimotext.uni-trier.de/prop/direct/P49>", seeds: "<http://data.mimotext.uni-trier.de/entity/Q1022>", reverse: true }
      ]
    },
    mmm: {
    ...
    monarch: {
      ...
      examples: [
        { label: "Gene interaction network of HGNC:4851", pred: "<https://w3id.org/biolink/vocab/interacts_with>", seeds: "<https://identifiers.org/hgnc/4851>", reverse: false },
        { label: "Genes that interact with HGNC:4851", pred: "<https://w3id.org/biolink/vocab/interacts_with>", seeds: "<https://identifiers.org/hgnc/4851>", reverse: true }
      ]
    },
    nomisma: {
    ...
    "wikidata-100mb": {
      ...
      examples: [
        { label: "Everyone influenced by this thinker (P737)", pred: "<http://www.wikidata.org/prop/direct/P737>", seeds: "<http://www.wikidata.org/entity/Q9312>", reverse: true },
  ...
  provenance: {
    ...
    "factgrid-illuminati": {
      ...
      examples: [
        ...
        { label: "Everything about the Order (Q10677)", tip: "Subject-bound: SPO routing to one entity's facts.", subject: "<https://database.factgrid.de/entity/Q10677>" }
      ]
    },
    history: {
    ...
    mimotext: {
      ...
      examples: [
        { label: "Every stylometric-similarity edge", tip: "Predicate-bound: the P49 style network as one POS run.", predicate: "<http://data.mimotext.uni-trier.de/prop/direct/P49>" },
        { label: "Everything about a novel (Q1011)", tip: "Subject-bound: SPO routing.", subject: "<http://data.mimotext.uni-trier.de/entity/Q1011>" }
      ]
    },
    mmm: {
      predicate: "<http://erlangen-crm.org/current/P51_has_former_or_current_owner>",
      examples: [
        { label: "Every ownership edge", tip: "Predicate-bound: the CIDOC-CRM P51 relation as one POS run.", predicate: "<http://erlangen-crm.org/current/P51_has_former_or_current_owner>" },
    ...
    "wikidata-100mb": {
      ...
      examples: [
        { label: "Every occupation edge", tip: "Predicate-bound: wdt:P106 as one POS run over the lazy file — each row shows the tile/byte range fetched.", predicate: "<http://www.wikidata.org/prop/direct/P106>" },
        { label: "All humans (P31 = Q5)", tip: "Object-bound: routed to OSP — every wdt:P31 -> wd:Q5 assertion.", predicate: "<http://www.wikidata.org/prop/direct/P31>", object: "<http://www.wikidata.org/entity/Q5>" }
      ]
    },
    "ohm-full": {
    ...
    wikidata: {
      predicate: "<http://www.wikidata.org/prop/direct/P106>",
      examples: [
        { label: "Every occupation edge (lazy, 1 GB)", tip: "Predicate-bound over the 1 GB file: wdt:P106 as one POS run — each row shows the tile/byte range fetched. Selective, so it stays cheap even at 1 GB.", predicate: "<http://www.wikidata.org/prop/direct/P106>" },
        { label: "All humans (P31 = Q5)", tip: "Object-bound: routed to OSP — every wdt:P31 -> wd:Q5 assertion over the lazy 1 GB graph.", predicate: "<http://www.wikidata.org/prop/direct/P31>", object: "<http://www.wikidata.org/entity/Q5>" }
      ]
    }
  }
};
