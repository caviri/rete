...
check_all "sparql-url forced lazy" "Bob" "solution" "in 39 range request(s)" -- env RETE_EAGER_MAX_MB=0 RETE_BLOCK_KB=0 $B sparql-url "http://127.0.0.1:8099/web.rete" "PREFIX e: <http://ex/> SELECT ?y WHERE { e:Alice e:knows ?y }"
