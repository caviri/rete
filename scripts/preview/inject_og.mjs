...
export const APP_PAGES = [
  ...
  { page: "explore-100mb.html", template: "web/explore-100mb.template.html", section: "Explore in the browser",
    title: "Explore 100 MB of Wikidata in the browser",
    description: "A 100 MB slice of Wikidata, queried straight from a static host with HTTP range reads — the whole file is never downloaded, only the bytes each query needs." },
